---
name: cto-advisor
description: Technical leadership guidance for engineering teams, architecture decisions, and technology strategy. Includes frameworks for tech debt assessment, team scaling, engineering metrics, and technology evaluation.
keywords: [CTO, chief technology officer, technical leadership, tech debt, technical debt, engineering team, team scaling, architecture decisions, technology evaluation, engineering metrics, DORA metrics, ADR, architecture decision records, technology strategy]
license: MIT
version: 1.0.0
...
#### Decision Making
Use ADR (Architecture Decision Record) template:
...
### Architecture
- Draw.io, Lucidchart, C4 Model

### Metrics
- DataDog, Grafana, LinearB
