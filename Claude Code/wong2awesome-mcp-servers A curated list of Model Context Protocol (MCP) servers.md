---
title: "wong2/awesome-mcp-servers: A curated list of Model Context Protocol (MCP) servers"
source: "https://github.com/wong2/awesome-mcp-servers"
author:
  - "[[wong2]]"
published:
created: 2025-10-28
description: "A curated list of Model Context Protocol (MCP) servers - wong2/awesome-mcp-servers"
tags:
  - "clippings"
---
A curated list of Model Context Protocol (MCP) servers

[mcpservers.org](https://mcpservers.org/ "https://mcpservers.org")

[MIT license](https://github.com/wong2/awesome-mcp-servers/blob/main/LICENSE)
...
- **Kiwi.com** - Official [Kiwi.com](https://www.kiwi.com/) flight search MCP server. Search and book flights directly from your favorite AI assistant.
...
- **[TrackMage](https://github.com/trackmage/trackmage-mcp-server)** - Shipment tracking api and logistics management capabilities through the \[TrackMage API\] ([https://trackmage.com/](https://trackmage.com/))
...
- **[gx-mcp-server](https://github.com/davidf9999/gx-mcp-server)** - Expose Great Expectations data validation and quality checks as MCP tools for AI agents. Load datasets, create validation suites, run data quality checks, and retrieve detailed results.
...
- **[irulescan MCP](https://github.com/simonkowallik/irulescan?tab=readme-ov-file#mcp-server)** - 🛡️ MCP enabled code security analyzer for F5 iRules
...
- **[run-sql-connectorx](https://github.com/gigamori/mcp-run-sql-connectorx)** - Execute SQL (PostgreSQL, MariaDB, BigQuery, MS SQL Server, RedShift, etc.) via ConnectorX and stream results to CSV/Parquet. MCP tool: run\_sql.
...
- **[SchemaFlow](https://github.com/CryptoRadi/schemaflow-mcp-server)** - Real-time PostgreSQL & Supabase database schema access for AI-IDEs via Model Context Protocol. Provides live database context through secure SSE connections with three powerful tools: get\_schema, analyze\_database, and check\_schema\_alignment. [SchemaFlow](https://schemaflow.dev/)
...
- **[Unified Diff MCP Server](https://github.com/gorosun/unified-diff-mcp)** - Beautiful HTML and PNG diff visualization using diff2html, designed for filesystem edit\_file dry-run output with high-performance Bun runtime.
